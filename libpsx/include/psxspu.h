...
void SsEnableCd(); // To enable audio from CDROM (cdrom demuted automatically)
void SsEnableExt(); // To enable audio from external device
void SsCdVol(unsigned short left, unsigned short right); // To set CDROM audio volume
